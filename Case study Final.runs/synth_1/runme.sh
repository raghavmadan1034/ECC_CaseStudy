...
HD_PWD='/users/misc/raghavm22/Desktop/Case study Final/Case study Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scalar_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scalar_mult.tcl
